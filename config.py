...
class DefaultConfig:
    ...
    #     APP_TYPE = os.environ.get("MicrosoftAppType", "MultiTenant")
        ...
        self.PORT = 8000
        self.APP_ID = os.environ.get("CHATBOT_BOT_ID", "3c699fe5-4776-47a0-93ca-baa0258c7958") #"this one"
        self.APP_PASSWORD = os.environ.get("CHATBOT_BOT_PASSWORD", "sjD8Q~pzxGQ3FQHil2TLW9Fg6Gsg.zRW2vA.Ydqs")#self.CHATBOT_BOT_ID = os.environ.get("CHATBOT_BOT_ID", "3c699fe5-4776-47a0-93ca-baa0258c7958")
